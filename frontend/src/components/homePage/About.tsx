  ...
  return (
    <div className="">
      <div className="flex flex-col  items-center  bg-[#325343] bg-[url('/Texture.png')] bg-cover bg-center pb-[200px] pt-[100px]">
        <div className="font-bold text-[60px] text-white mt-[100px]">
          Бидний тухай
        </div>
        <div className="text-sm  text-white w-[870px] mt-[50px]">
      ...
      <div className="flex flex-col  items-center">
        ...
        <div className="text-sm  w-[1000px] text-[#102d3f] mt-[50px] mb-[50px]">
      ...
      <img src="/nvb.png" alt="" className="mb-[200px] " />
    </div>
  );
};
